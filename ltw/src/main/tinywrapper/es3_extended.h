...
GLESFUNC(glShaderStorageBlockBinding, PFNGLSHADERSTORAGEBLOCKBINDINGPROC)
GLESFUNC(glBindImageTexture, PFNGLBINDIMAGETEXTUREPROC)
GLESFUNC(glBindBuffersBase, PFNGLBINDBUFFERSBASEPROC)
GLESFUNC(glBindBuffersRange, PFNGLBINDBUFFERSRANGEPROC)
