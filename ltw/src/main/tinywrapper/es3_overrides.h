...
GLESOVERRIDE(glMemoryBarrierByRegion)
GLESOVERRIDE(glShaderStorageBlockBinding)
GLESOVERRIDE(glBindImageTexture)
GLESOVERRIDE(glBindBuffersBase)
GLESOVERRIDE(glBindBuffersRange)
GLESOVERRIDE(glMultiDrawArraysIndirect)
GLESOVERRIDE(glMultiDrawElementsIndirect)
